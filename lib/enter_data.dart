                    ...
                    Align(
                      ...
                      child: Column(
                          ...
                          children: [
                                      ...
                                      child: TextFormField(
                                        ...
                                        onTap: () async {
                                          ...
                                          setState(() {
                                            ...
                                            textfield_abn_focus.requestFocus();
                                          });
                                        },
                            ...
                            Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(45, 10, 45, 5),
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Expanded(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (date == null)
                                          return; // user cancels date selection
                                        final time = await showTimePicker(
                                          helpText: 'Spiegelabnahme-Zeitpunkt',
                                          context: context,
                                          initialTime: TimeOfDay.now(),
                                        );
                                        if (time == null)
