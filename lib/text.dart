  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        ...
        children: [
          Text('Wählen Sie eine Berechnung:        '),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              ElevatedButton(
                child: Text('Talspiegelberechnung'),
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                    ...
                    showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            title: Text("Talspiegelberechnung"),
                            content: Text(
                                "Berechnen Sie anhand von wenigen Parametern den theoretischen Talspiegel eines Medikaments, bei Abnahme vor dem eigentlichen Spiegeltiefpunkt."),
                            actions: [
                              TextButton(
                                  onPressed: () {
                  ...
                  onPressed: () {
                    showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            backgroundColor: Color.fromARGB(236, 149, 204, 252),
                            title: Text("Dosisberechnung"),
                            content: Text("Soon to come"),
                            actions: [
                              TextButton(
                                  onPressed: () {
                                    Navigator.of(context).pop();
                                      ...
                                      onChanged: (String? value) {
                                        setState(() {
                                          if (value == 'Alle') {
                                            ...
                                            textfield_hwz.text = '';
                                            textfield_tmin.text = '';
                                            dropdownItems = AntidepressivaItems;
                                            ...
                                            textfield_hwz.text = '';
                                            textfield_tmin.text = '';
                                            dropdownItems = AntpsychotikaItems;
                                            ...
                                            textfield_hwz.text = '';
                                            textfield_tmin.text = '';
                                            dropdownItems = AntikonvulsivaItems;
